...
- [1. Easy Question: Remove Duplicates from Sorted Array](#1-easy-question-remove-duplicates-from-sorted-array)
- [2. Solution](#2-solution)
  - [2.1. Approach 1: Two Pointer](#21-approach-1-two-pointer)
  - [2.2. Run Code Result](#22-run-code-result)

<!-- /TOC -->

## 1. Easy Question: Remove Duplicates from Sorted Array
